...
public class ListDateTimeOfFlightViewHoder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public ListDateTimeOfFlightViewHoder(@NonNull View itemView) {
        super(itemView);
    ...
    public ListDateTimeOfFlightViewHoder setListener(onItemClickListener listener) {
