...
public class ListPopularDestinationsHotelViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    public ImageView img;
    public TextView txt;

    private onItemClickListener listener;

    public ListPopularDestinationsHotelViewHolder(@NonNull View itemView) {
        super(itemView);
